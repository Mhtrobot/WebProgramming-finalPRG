                    ...
                    <div className="main-user container-fluid ">
                        ...
                        <div className={'list w-50'}>
                            <ul className={"list-group"}>
                                {list.map((todo, index)=>(
                                    <div key={index}
                                         className={`todo container-fluid mt-2 p-3 ${todo.status === 'true' ? 'grayed-out' : ''}`}>
                                        ...
                                        <div className={`icon col-lg-4 ${todo.status === 'true' ? 'grayed-out' : ''}`}>
                                            <button onClick={() => deleteTodo(todo.todo_id)} className={`mt-1 mr-2`}>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                     fill="red" className={`bi bi-trash ${todo.status === 'true' ? 'grayed-out' : ''}`} viewBox="0 0 16 16">
                                                    <path
                                            ...
                                            <button onClick={() => markAsDone(todo.todo_id)}
                                                    disabled={todo.status === 'true'} className='mt-1'>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                     fill="green" className={`bi bi-clipboard-check ${todo.status === 'true' ? 'grayed-out' : ''}`} viewBox="0 0 16 16">
